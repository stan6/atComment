...
public abstract class GenInputsAbstract extends CommandHandler {
  ...
  @Option("Infer null annotation and use it to limit test generation")
  public static boolean use_null_annotation = false;
  
  @Option("Force null as input for statements with null inferences")
  public static boolean force_null = false;
  
  @Option("Path for specifying the source to be annotated")
